...
namespace NArrange.Tests.Core.Configuration
{
	...
	public class InterfaceReferenceTests
	{
		...
		public void CreateDefaultTest()
		{
			...
			Assert.AreEqual(InterfaceReferenceType.None, reference1.ReferenceType,
			    "Unexpected default value for ReferenceType.");
		}
		...
		public void CreateTest()
		{
			...
			Assert.AreEqual(InterfaceReferenceType.Interface, reference1.ReferenceType,
			    "Unexpected value for ReferenceType.");
		}
		...
		public void ReferenceTypeTest()
		{
			...
			Assert.AreEqual(InterfaceReferenceType.Class, reference.ReferenceType, 
			    "Unexpected value for ReferenceType.");
		}
