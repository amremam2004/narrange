	...
	public class VBParserTests
	{
		...
		public void ParseAssemblyAttributesTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.AreEqual("AssemblyTitle", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"NArrange.Core.Tests\"", attributeElement.BodyText,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyDescription", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyConfiguration", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyCompany", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyProduct", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"NArrange.Core.Tests\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyCopyright", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"Copyright ©  2007\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			        "An unexpected number of header comment lines were parsed.");
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyTrademark", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyCulture", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("ComVisible", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("False", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(3, attributeElement.HeaderComments.Count,
			        "An unexpected number of header comment lines were parsed.");
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("Guid", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"def01aba-79c5-4082-9522-e570c52a2df1\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyVersion", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"1.0.0.0\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    ...
			    Assert.AreEqual("assembly", attributeElement.Target,
			       "Unexpected attribute target.");
			    Assert.AreEqual("AssemblyFileVersion", attributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"1.0.0.0\"", attributeElement.BodyText,
			        "Unexpected attribute text.");
			    Assert.AreEqual(0, attributeElement.HeaderComments.Count,
		...
		public void ParseAttributeListTest()
		{
			...
			Assert.AreEqual("AssemblyDescription", attributeElement.Name,
			    "Unexpected attribute name.");
			Assert.AreEqual("\"SampleAssembly\"", attributeElement.BodyText,
			    "Unexpected attribute text.");

			Assert.AreEqual(3, attributeElement.Children.Count,
			...
			Assert.IsNotNull(attributeChildElement,
			    "Element is not an AttributeElement.");
			Assert.AreEqual("assembly", attributeChildElement.Target,
			    "Unexpected attribute target.");
			Assert.AreEqual("ComVisible", attributeChildElement.Name,
			    "Unexpected attribute name.");
			Assert.AreEqual("false", attributeChildElement.BodyText,
			    "Unexpected attribute text.");
			...
			Assert.AreEqual("assembly", attributeChildElement.Target,
			    "Unexpected attribute target.");
			Assert.AreEqual("AssemblyConfiguration", attributeChildElement.Name,
			    "Unexpected attribute name.");
			Assert.AreEqual("\"\"", attributeChildElement.BodyText,
			    "Unexpected attribute text.");
			...
			Assert.AreEqual("assembly", attributeChildElement.Target,
			    "Unexpected attribute target.");
			Assert.AreEqual("TestAttribute", attributeChildElement.Name,
			    "Unexpected attribute name.");
			Assert.IsNull(attributeChildElement.BodyText,
			    "Unexpected attribute text.");
		}
		...
		public void ParseClassMultipleTypeParameterTest()
		{
			...
			Assert.AreEqual(TypeElementType.Class, classElement.Type,
				"Expected a class.");
		...
		public void ParseDelegatesTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.IsNull(delegateElement.Type,
				...
				Assert.IsFalse(delegateElement.IsStatic,
					"Delegate should not be static.");
				Assert.AreEqual("Integer", delegateElement.Type,
					"Unexpected return type.");
				Assert.IsFalse(delegateElement.IsAbstract,
					"Delegate should not be abstract.");
				Assert.IsFalse(delegateElement.IsOverride,
		...
		public void ParseEventsTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.IsFalse(eventElement.IsStatic,
			        "Delegate should not be static.");
			    Assert.AreEqual("EventHandler(Of EventArgs)", eventElement.Type,
			        "Unexpected return type.");
			    Assert.IsFalse(eventElement.IsAbstract,
			        "Event should not be abstract.");
			    Assert.IsFalse(eventElement.IsOverride,
			    ...
			    Assert.IsFalse(eventElement.IsStatic,
			        "Delegate should not be static.");
			    Assert.IsNull(eventElement.Type,
			        "Unexpected return type.");
		...
		public void ParseFieldGenericTest()
		{
			...
			Assert.AreEqual("Dictionary(Of String, Integer)", fieldElement.Type,
		...
		public void ParseFieldWithEventsTest()
		{
			...
			Assert.IsFalse(fieldElement.IsStatic,
			    "Unexpected value for IsStatic.");
			Assert.AreEqual("Button", fieldElement.Type,
			    "Unexpected member type.");
		...
		public void ParseFieldsTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.AreEqual("_fieldWithInitialVal", field.Name,
			        "Unexpected field name.");
			    Assert.AreEqual("Integer", field.Type,
			        "Unexpected field type.");
			    ...
			    Assert.AreEqual("_genericField", field.Name,
			        "Unexpected field name.");
			    Assert.AreEqual("Nullable(Of Integer)", field.Type,
			        "Unexpected field type.");
			    Assert.AreEqual(CodeAccess.Private, field.Access,
			        "Unexpected field access level.");
			    Assert.IsNull(field.InitialValue,
		...
		public void ParseFunctionExternalTest()
		{
			...
			foreach (string variation in variations)
			{
			    ...
			    Assert.AreEqual("ByVal filename As String", methodElement.Parameters,
			       "Unexpected parameters.");
			    Assert.AreEqual("String", methodElement.Type,
			        "Unexpected return type.");
		...
		public void ParseMethodsTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.IsFalse(method.IsStatic,
			        "Method should not be static.");
			    Assert.AreEqual("Boolean", method.Type,
			        "Unexpected return type.");
			    Assert.IsFalse(method.IsAbstract,
			        "Method should not be abstract.");
			    Assert.IsFalse(method.IsOverride,
			    ...
			    Assert.AreEqual("Nullable(Of Integer)", method.Type,
			        "Unexpected return type.");
			    Assert.IsFalse(method.IsAbstract,
			        "Method should not be abstract.");
			    Assert.IsFalse(method.IsOverride,
			    ...
			    Assert.IsTrue(method.IsStatic,
			        "Method should be static.");
			    Assert.AreEqual("Integer", method.Type,
			        "Unexpected return type.");
			    Assert.IsFalse(method.IsAbstract,
			        "Method should not be abstract.");
		...
		public void ParseModuleSimpleTest()
		{
			...
			Assert.AreEqual(CodeAccess.Public, typeElement.Access,
			    "Unexpected code access.");
			Assert.AreEqual(TypeElementType.Module, typeElement.Type,
			    "Unexpected type element type.");
		}
		...
		public void ParseMultiClassDefinitionTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
				...
				Assert.IsNull(disposeMethod.Type,
					"Unexpected return type.");
		...
		public void ParseOperatorsTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
				...
				Assert.IsTrue(operatorElement.IsStatic,
					"Expected operator to be static.");
				Assert.AreEqual("Boolean", operatorElement.Type,
					"Unexpected operator return type.");
				Assert.AreEqual("ByVal a As Fraction, ByVal b As Fraction", operatorElement.Parameters,
					"Unexpected operator parameters.");
				Assert.IsTrue(operatorElement.BodyText.Contains("Return"),
		...
		public void ParsePropertiesTest()
		{
			...
			using (TextReader reader = testFile.GetReader())
			{
			    ...
			    Assert.IsFalse(property.IsStatic,
			        "Property should not be static.");
			    Assert.AreEqual("Nullable(Of Integer)", property.Type,
			       "Unexpected property type.");
			    Assert.IsFalse(property.IsAbstract,
			        "Property should not be abstract.");
			    Assert.IsFalse(property.IsOverride,
			    ...
			    Assert.AreEqual("Description", childAttributeElement.Name,
			        "Unexpected attribute name.");
			    Assert.AreEqual("\"Multiple attribute property.\"", childAttributeElement.BodyText,
			        "Unexpected attribute text.");
